...
#define OS_LOG_WARNING_ENABLED() LOG_ENABLED (LOG_LEVEL_WARNING | LOG_STATE_ON)
#define OS_LOG_ERROR_ENABLED()   LOG_ENABLED (LOG_LEVEL_ERROR | LOG_STATE_ON)
#define OS_LOG_FATAL_ENABLED()   LOG_ENABLED (LOG_LEVEL_FATAL | LOG_STATE_ON)
